import { Outlet as Content, Link } from "react-router-dom";

import AdminImage from './../assests/images.png'


{/* SVG icons of the templates */ }
const SvgIcons = () => {
    return (
        <>
    ...
    return (
        <>
            <header className="navbar sticky-top bg-primary flex-md-nowrap p-0 shadow" data-bs-theme="dark">
                <Link className="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" to={links.employees}>
                    {title}
                </Link>
                ...
                <div id="navbarSearch" className="navbar-search w-100 ">
                    <input className="form-control w-100 rounded-0 border-0 bg-primary" type="text" placeholder="Effectuer une recherche" aria-label="Search" />
                </div>
            </header>
        </>
    );
                ...
                <div className="offcanvas-md offcanvas-end bg-body-tertiary" tabIndex={-1} id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul className="nav flex-column">
                            <li className="nav-item p-2">
                                <div className="card text-center p-3">
                                    <img src={AdminImage} className="card-img-top" style={{ width: '120px', margin: 'auto' }} />
                                    <div className="card-body p-0">
                                        <p className="card-text m-0">Bonjour,</p>
                                        <h3 className="card-title">ADMIN</h3>
                                    </div>
                                </div>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center gap-2 active" to={links.employees}>
                                    <svg className="bi">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center gap-2" to={links.banks}>
                                    <svg className="bi">
                        ...
                        <ul className="nav flex-column mb-auto">
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center gap-2" to={links.addemployee}>
                                    <svg className="bi">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center gap-2" to={links.addbank}>
                                    <svg className="bi">
                                        <use xlinkHref="#file-earmark-text" />
                                    </svg>
                                    Ajouter une banque
